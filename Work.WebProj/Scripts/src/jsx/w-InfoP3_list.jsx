			...
			<div id="content">
				<section className="wrap">
					<header className="title">
                            <h2 className="float-l">行前注意事項</h2>
					</header>
	...
	render:function(){
		var outHtml = (
				<ul className="breadcrumb">
					...
					<li><a href={gb_approot+'Info/p3'}>遊學/留學小幫手</a></li>
                    <li>行前注意事項</li>
				</ul>
		);
...
var comp = React.render(<PageContent dataUrl={gb_approot + 'api/GetAction/GetInfoP3WWW'} contextUrl={gb_approot + 'Info/p1_content?id='} />,document.getElementById('PageContent'));