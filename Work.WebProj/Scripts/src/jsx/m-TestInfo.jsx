...
var GirdForm = React.createClass({
	...
	getDefaultProps:function(){
		return{	
			fdName:'fieldData',
			gdName:'searchData',
			apiPathName:gb_approot+'api/TestInfo',
			initPathName:gb_approot+'Active/TestInfo/aj_Init'
	...
	handleSubmit: function(e) {
		...
		if(this.state.edit_type==1){
			...
			this.state.fieldData.test_info_content = CKEDITOR.instances.editor1.getData();//編輯器
	...
	deleteSubmit:function(e){
		...
		for(var i in this.state.gridData.rows){
			if(this.state.gridData.rows[i].check_del){
				ids.push('ids='+this.state.gridData.rows[i].test_info_id);
			}
		}
				...
				<form className="form-horizontal" onSubmit={this.handleSubmit}>
					...
					<div className="form-group">
						...
						<div className="col-xs-6">
							<MasterImageUpload 
							FileKind="Photo1" 
							MainId={fieldData.test_info_id}
							ParentEditType={this.state.edit_type}
							url_upload={gb_approot + 'Active/TestInfo/axFUpload'}
							url_list={gb_approot+'Active/TestInfo/axFList'}
							url_delete={gb_approot+'Active/TestInfo/axFDelete'}
							url_sort={gb_approot+'Active/TestInfo/axFSort'}
							/>
						</div>
						...
						<label className="col-xs-1 control-label">內容</label>
							<div className="col-xs-10">
								<textarea type="date" className="form-control" rows="3" id="editor1"
									value={fieldData.test_info_content}
									onChange={this.changeFDValue.bind(this,'test_info_content')} />
							</div>
					</div>
