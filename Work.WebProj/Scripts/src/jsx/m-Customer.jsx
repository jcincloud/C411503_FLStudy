	...
	render:function(){
		return (
				...
				<tr>
					...
					<td>{this.props.itemData.mobile}</td>
					<td>{this.props.itemData.contact_1}</td>
				</tr>
			);
		}
});
						...
						<table>
							<thead>
								<tr>
									...
									<th className="col-xs-3">電話</th>
									<th className="col-xs-2">行動</th>
									<th className="col-xs-2">負責人</th>
								</tr>
							</thead>
							<tbody>
								{
			...
			<div>
				...
				<form className="form-horizontal" onSubmit={this.handleSubmit}>
					<div className="form-group">
						...
						<label className="col-xs-1 control-label">聯絡人1</label>
						<div className="col-xs-3">
							<input type="text" 
							className="form-control"	
						...
						<label className="col-xs-1 control-label">生日</label>
						<div className="col-xs-3">
