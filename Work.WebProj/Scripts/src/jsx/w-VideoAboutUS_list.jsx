...
var comp = React.render(<PageContent dataUrl={gb_approot + 'api/GetAction/GetAoubtUSVideoWWW'} contextUrl={gb_approot + 'StudyA/p1_content?id='} />,document.getElementById('PageContent'));