...
var GirdForm = React.createClass({
    ...
    getInitialState: function () {
        return {
            ...
            fieldData: {},
            searchData: { name: null, category: 2 },
            edit_type: 0,
            checkAll: false,
            countryCategory: []
        };
    ...
    insertType: function () {
        ...
        this.setState({ edit_type: 1, fieldData: { vacation_category: 1003, country_category: defaultC[0].val } });
    },
    updateType: function (id) {
		...
		.done(function (data, textStatus, jqXHRdata) {
		    ...
		    // CKEDITOR.replace('editor2', { contentsCss: '../../Content/css/editor.css' });
		    // CKEDITOR.replace('editor3', { contentsCss: '../../Content/css/editor.css' });
		    // CKEDITOR.replace('editor4', { contentsCss: '../../Content/css/editor.css' });
		}.bind(this))
		.fail(function (jqXHR, textStatus, errorThrown) {
		    showAjaxError(errorThrown);
		});
			...
			<div>
				...
				<div className="form-group">
					...
					<div className="form-group">
						...
						<div className="col-xs-7">
							<MasterImageUpload FileKind="Banner"
                                               MainId={fieldData.study_abroad_id}
                                               ParentEditType={this.state.edit_type}
                                               url_upload={gb_approot + 'Active/StudyAbroadData/axFUpload'}
                                               url_list={gb_approot+'Active/StudyAbroadData/axFList'}
					...
					<div className="form-group">
						...
						<div className="col-xs-7">
							<MasterImageUpload FileKind="Photo2"
                                               MainId={fieldData.study_abroad_id}
                                               ParentEditType={this.state.edit_type}
                                               url_upload={gb_approot + 'Active/StudyAbroadData/axFUpload'}
                                               url_list={gb_approot+'Active/StudyAbroadData/axFList'}
