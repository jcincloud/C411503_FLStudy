			...
			<div id="content">
				<section className="article-list wrap">
					<header className="title">
						<h2 className="float-l">世界大学资料库</h2>
						<div className="select">
							...
							<br />
							<label for="">校名</label>
							<input type="text" placeholder="请输入关键字" onChange={this.titleChange}/>
						</div>
					</header>
	...
	render:function(){
		var outHtml = (
			<ul className="breadcrumb">
				...
				<li><a href={gb_approot+'StudyAbroad'}>海外留学</a></li>
				<li>世界大学资料库</li>
			</ul>
		);
...
var comp = React.render(<PageContent dataUrl={gb_approot + 'api/GetAction/GetAbroadSchoolWWW'} contextUrl={gb_approot + 'StudyAbroad/content?id='} />,document.getElementById('PageContent'));