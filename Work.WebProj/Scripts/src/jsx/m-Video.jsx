...
var GirdForm = React.createClass({
	...
	insertType:function(){
		this.setState({edit_type:1,fieldData:{category:3001,i_Hide:false}});
	},
		...
		else if(this.state.edit_type==1 || this.state.edit_type==2)
		{
			...
			<div>
				...
				<div className="form-group">
					...
					<div className="form-group">
						<label className="col-xs-1 control-label">影片標題</label>
						<div className="col-xs-6">
							<input type="text" 
					...
					<div className="form-group">
						<label className="col-xs-1 control-label">影片網址</label>
						<div className="col-xs-6">
							<input type="text" 
							className="form-control"	
