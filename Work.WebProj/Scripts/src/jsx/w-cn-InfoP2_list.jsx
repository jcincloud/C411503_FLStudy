...
var comp = React.render(<PageContent dataUrl={gb_approot + 'api/GetAction/GetInfoP2WWW'} contextUrl={gb_approot + 'Info/p1_content?id='} />,document.getElementById('PageContent'));