    ...
    render: function () {
		...
		<div>
			...
			<div id="content">
					...
					</header>
				    {
						this.state.gridData.rows.map(function (itemData, i) {
							...
							<article className="pic-article" key={i}>
								<a href={this.props.contextUrl + itemData.study_abroad_id} className="thumb"><img data-src={itemData.imgsrc} src={itemData.imgsrc} /></a>
				...
				<PageWWW pageFirst={this.pageFirst}
