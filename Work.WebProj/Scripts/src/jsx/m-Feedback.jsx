...
var GirdForm = React.createClass({
	...
	getDefaultProps:function(){
		return{	
			fdName:'fieldData',
			gdName:'searchData',
			apiPathName:gb_approot+'api/Feedback',
			initPathName:gb_approot+'Active/Feedback/aj_Init'
	...
	handleSubmit: function(e) {
		...
		if(this.state.edit_type==1){
			...
			this.state.fieldData.feedback_content = CKEDITOR.instances.editor1.getData();//編輯器
	...
	deleteSubmit:function(e){
		...
		for(var i in this.state.gridData.rows){
			if(this.state.gridData.rows[i].check_del){
				ids.push('ids='+this.state.gridData.rows[i].feedback_id);
			}
		}
				...
				<form className="form-horizontal" onSubmit={this.handleSubmit}>
					...
					<div className="form-group">
						...
						<div className="col-xs-7">
							<MasterImageUpload 
							FileKind="Photo1" 
							MainId={fieldData.feedback_id}
							ParentEditType={this.state.edit_type}
							url_upload={gb_approot + 'Active/Feedback/axFUpload'}
							url_list={gb_approot+'Active/Feedback/axFList'}
							url_delete={gb_approot+'Active/Feedback/axFDelete'}
							url_sort={gb_approot+'Active/Feedback/axFSort'}
							/>
						</div>
					...
					<div className="form-group">
						<label className="col-xs-1 control-label">簡短摘要</label>
							<div className="col-xs-7">
								<textarea type="date" className="form-control" rows="3"
									value={fieldData.feedback_sort}
									onChange={this.changeFDValue.bind(this,'feedback_sort')}
									maxLength="400" />
							</div>
					</div>
					...
					<div className="form-group">
						<label className="col-xs-1 control-label">心得內容</label>
							<div className="col-xs-10">
								<textarea type="date" className="form-control" rows="3" id="editor1"
									value={fieldData.feedback_content}
									onChange={this.changeFDValue.bind(this,'feedback_content')} />
							</div>
					</div>
