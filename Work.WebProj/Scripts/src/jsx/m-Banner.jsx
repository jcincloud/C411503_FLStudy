	...
	render: function() {
		...
		if(this.state.edit_type==0)
		{
			...
			<div>
				...
				<div className="alert alert-warning clear" role="alert">
					<p>最多顯示5張圖片，如超過5張圖片設定為顯示，會依序顯示最前面的5張。</p>
				</div>
		...
		else if(this.state.edit_type==1 || this.state.edit_type==2)
		{
			...
			<div>
				...
				<h4 className="title">設定 {this.props.caption}</h4>
				...
				<div className="form-group">
						<label className="col-xs-1 control-label">上傳圖片</label>
						<div className="col-xs-6">
							<MasterImageUpload
							FileKind="Banner" 
							MainId={fieldData.banner_id}
							ParentEditType={this.state.edit_type}
							url_upload={gb_approot + 'Active/Banner/axFUpload'}
							url_list={gb_approot+'Active/Banner/axFList'}
							url_delete={gb_approot+'Active/Banner/axFDelete'}
					...
					<div className="form-group">
						<label className="col-xs-1 control-label">連結網址</label>
							<div className="col-xs-6">
								<input type="text" 
								className="form-control"	
								value={fieldData.banner_url}
								onChange={this.changeFDValue.bind(this,'banner_url')}
								maxLength="400" />	
							</div>
