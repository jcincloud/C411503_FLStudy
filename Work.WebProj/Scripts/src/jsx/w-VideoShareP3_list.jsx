...
var comp = React.render(<PageContent dataUrl={gb_approot + 'api/GetAction/GetShareP3VideoWWW'} contextUrl={gb_approot + 'StudyA/p1_content?id='} />,document.getElementById('PageContent'));