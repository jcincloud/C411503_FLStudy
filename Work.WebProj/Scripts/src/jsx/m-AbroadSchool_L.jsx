...
var GirdForm = React.createClass({
    ...
    getInitialState: function() {
        return {
            ...
            fieldData:{},
            searchData:{title:null,country:null,operation:null,category:2},
            edit_type:0,
            checkAll:false,
            countryCategory:[],
            tmp_info:null,
    ...
    insertType:function(){
        ...
        this.setState({edit_type:1,fieldData:{country_category:defaultC[0].val,operation_category:0,school_info:this.state.tmp_info,school_apply:this.state.tmp_apply,category:2}});
    },
			...
			<div>
				...
				<form className="form-horizontal" onSubmit={this.handleSubmit}>
					...
					<div className="form-group">
						...
						<div className="col-xs-7">
							<MasterImageUpload FileKind="Photo3"
                                               MainId={fieldData.abroad_school_id}
                                               ParentEditType={this.state.edit_type}
                                               url_upload={gb_approot + 'Active/AbroadSchool/axFUpload'}
                                               url_list={gb_approot+'Active/AbroadSchool/axFList'}
					...
					<div className="form-group">
						<label className="col-xs-1 control-label">學校簡介</label>
