...
namespace ProcCore.Business.DB0
{
    ...
    {
        public int abroad_school_id { get; set; }
        public string school_title { get; set; }
        public string list_intro { get; set; }
        public string content_intro { get; set; }
        public string school_features { get; set; }
        public string school_info { get; set; }
        public string school_apply { get; set; }
        public int category { get; set; }
        public int country_category { get; set; }
        public int operation_category { get; set; }
